# NOTE: This module has been moved from fm_based_workers.
...
def http_task(http_request: dict[str, Any] | str) -> TaskResult:
    ...
    if method is None or method.upper() not in [
        "GET",
        "PUT",
        "POST",
        "DELETE",
    ...
    verify_cert = (
        http_request["verifyCertificate"]
        if "verifyCertificate" in http_request
        else True
    )
