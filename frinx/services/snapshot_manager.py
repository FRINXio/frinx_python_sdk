...
def create_snapshot(
    node_ids: list[str], snapshot_name: str, transaction_id: str, uniconfig_url_base: str | None = None
) -> requests.Response:
    """
...
def delete_snapshot(
    snapshot_name: str, transaction_id: str, uniconfig_url_base: str | None = None
) -> requests.Response:
    """
...
def replace_config_with_snapshot(
    snapshot_name: str, node_ids: list[str], transaction_id: str, uniconfig_url_base: str | None = None
) -> requests.Response:
    """
