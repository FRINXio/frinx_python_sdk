...
def close_transaction(transaction_id: str, uniconfig_url_base: str | None = None) -> requests.Response:
    """
...
def commit_transaction(
    ...
    Args:
        ...
        validate: Validate constraints and consistency of the transaction.
        uniconfig_url_base: Override default Uniconfig url.
...
def replace_config_with_operational(
    node_ids: list[str], transaction_id: str, uniconfig_url_base: str | None = None
) -> requests.Response:
    """
